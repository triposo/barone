...
public class FlowLayout extends ViewGroup {
  ...
  public FlowLayout(Context context, AttributeSet attrs) {
    ...
    horizontalSpacing = styledAttributes.getDimensionPixelSize(R.styleable.FlowLayout_android_horizontalSpacing,
        DEFAULT_HORIZONTAL_SPACING);
    verticalSpacing = styledAttributes.getDimensionPixelSize(R.styleable.FlowLayout_android_verticalSpacing,
